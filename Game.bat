...
cls
	...
	if %answer%==0 (goto Stage_4JEnd) else (goto Menu)
...
cls
	...
	ping -n 1 -w 1500 192.168.254.254 >nul
	echo -Какой нахуй бесполезен, я этот навык повсеместно использую. Был бы бесполезным, лежал бы на полочке, гнил помаленьку
	ping -n 1 -w 1500 192.168.254.254 >nul
...
cls
	...
	ping -n 1 -w 1000 192.168.254.254 >nul
	echo Замок в MoneyTown. В округе находятся огромное количество подземелий с разным уровнем
	ping -n 1 -w 3000 192.168.254.254 >nul
...
cls
	...
	ping -n 1 -w 1500 192.168.254.254 >nul
	echo ---ЗАФИКСИРОВАНО ЧАСТИЧНОЕ ОТКРЫТИЕ ЯЧЕЙКИ ПАМЯТИ---
	ping -n 1 -w 1500 192.168.254.254 >nul
	echo 
	ping -n 1 -w 1500 192.168.254.254 >nul
pause
